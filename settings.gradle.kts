...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("appcompat", "androidx.appcompat:appcompat:1.3.1")
            library("core-ktx", "androidx.core:core-ktx:1.6.0")
            library("activity-ktx", "androidx.activity:activity-ktx:1.3.1")
            library("fragment-ktx", "androidx.fragment:fragment-ktx:1.3.6")
            library("annotations", "androidx.annotation:annotation:1.2.0")
            library("material", "com.google.android.material:material:1.4.0")
            library("constraint-layout", "androidx.constraintlayout:constraintlayout:2.1.0")
            ...
            library("lifecycle-java8", "androidx.lifecycle:lifecycle-common-java8:2.2.0")
            library("lifecycle-extensions", "androidx.lifecycle:lifecycle-extensions:2.2.0")
            library("lifecycle-compiler", "androidx.lifecycle:lifecycle-compiler:2.2.0")
            library("room-runtime", "androidx.room", "room-runtime").versionRef("room")
            library("room-compiler", "androidx.room", "room-compiler").versionRef("room")
            library("work-runtime-ktx", "androidx.work:work-runtime-ktx:2.5.0")
            library("browser", "androidx.browser:browser:1.3.0")
            ...
            library("jsoup", "org.jsoup:jsoup:1.13.1")
